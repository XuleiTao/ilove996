...
def vis_detections(im, class_name, dets, thresh=0.5):
    ...
    plt.tight_layout()
    plt.draw()
    plt.savefig('/home/jovyan/lcc/faster_rcnn_endernewton/tf-faster-rcnn-master/123.png') 
...
#     im_names = ['004.png','000.png','001.png']
...
#     plt.show()
    ...
    output_graph = "./data/oo/ship_model_from_demo3.pb"
